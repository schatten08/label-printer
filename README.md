...
Если вы устанавливаете программу впервые, зайдите в папку **`setup`** и запустите нужный файл от имени Администратора:
- **Windows**: Запустите `Install_Setup.bat`.
- **macOS**: Запустите `Install_Mac.command`.

Он сам проверит наличие Python, установит библиотеки и создаст ярлык на вашем Рабочем столе.
