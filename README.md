...
Если вы устанавливаете программу впервые, просто запустите файл **`Install_Setup.bat`** от имени Администратора. Он:
1. Проверит наличие Python.
2. Установит все нужные библиотеки сам.
3. Создаст удобный ярлык на вашем Рабочем столе.

*Примечание: Вам всё еще нужно скачать и установить [Brother bPAC SDK](https://support.brother.com/g/s/es/dev/en/bpac/index.html) вручную, если его еще нет.*

### 🏃 Шаг 2: Запуск программы
После установки просто запустите ярлык **"Label Printer"** с Рабочего стола.
Или используйте файл **`Start Windows Version.bat`** в папке проекта.
